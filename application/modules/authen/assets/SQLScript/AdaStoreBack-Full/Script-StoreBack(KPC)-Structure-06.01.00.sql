...
DECLARE @tTblName VARCHAR(30)
DECLARE @tColName VARCHAR(30)
DECLARE @tNULLABLE VARCHAR(30)
DECLARE @tIndexName VARCHAR(50)
DECLARE @tSql NVARCHAR(250)
DECLARE @tPKName VARCHAR(50)
DECLARE @tPKFed VARCHAR(200)

DECLARE Col_Cursor CURSOR FOR
SELECT Col.TABLE_NAME,COLUMN_NAME,IS_NULLABLE
FROM INFORMATION_SCHEMA.COLUMNS Col
WHERE COLUMN_NAME = 'FTPdtSerial'
ORDER BY TABLE_NAME

OPEN Col_Cursor
FETCH NEXT FROM Col_Cursor INTO @tTblName,@tColName,@tNULLABLE

WHILE @@FETCH_STATUS = 0
BEGIN
	IF(@tNULLABLE = 'YES')
		SET @tSql = 'ALTER TABLE ' + @tTblName + ' ALTER COLUMN ' + @tColName + ' VARCHAR(50)' 
	ELSE
		SET @tSql = 'ALTER TABLE ' + @tTblName + ' ALTER COLUMN ' + @tColName + ' VARCHAR(50) NOT NULL' 
...
IF OBJECT_ID(N'TCNMPrnServerSpc') IS NULL BEGIN
	CREATE TABLE [dbo].[TCNMPrnServerSpc](
		[FTAgnCode] [varchar](10) NOT NULL,
		[FTSrvCode] [varchar](10) NOT NULL,
		[FTPlbCode] [varchar](10) NOT NULL,
		[FTLblCode] [varchar](10) NULL,
	 CONSTRAINT [PK_TCNMPrnServerSpc] PRIMARY KEY CLUSTERED 
	(
		[FTAgnCode] ASC,
		[FTSrvCode] ASC,
		[FTPlbCode] ASC
	...
	EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'รหัสคู้ค้า' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'TABLE',@level1name=N'TCNMPrnServerSpc', @level2type=N'COLUMN',@level2name=N'FTAgnCode'
	EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'รหัส Server เครื่องพิมพ์' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'TABLE',@level1name=N'TCNMPrnServerSpc', @level2type=N'COLUMN',@level2name=N'FTSrvCode'
	EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'รหัสพิมพ์ Label' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'TABLE',@level1name=N'TCNMPrnServerSpc', @level2type=N'COLUMN',@level2name=N'FTPlbCode'
	EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'รหัส Label' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'TABLE',@level1name=N'TCNMPrnServerSpc', @level2type=N'COLUMN',@level2name=N'FTLblCode'
END
GO
...
-- โดย			 : เจมส์
-- เวอร์ชั่น		: 05.01.00
-- เพิ่มเงื่อนไขเอาเฉพาะบาร์โค้ดที่ใช้งานอยู่

IF EXISTS (SELECT 1 FROM sys.views WHERE name='VCN_ProductsHQ' and type='v') DROP VIEW VCN_ProductsHQ
GO

CREATE VIEW VCN_ProductsHQ AS
SELECT	PDT.FTPdtCode, PDT_L.FTPdtName, PDT.FTPdtForSystem, PDT.FTPdtStaVatBuy, PDT.FTPdtStaVat, PDT.FTVatCode, ISNULL(VAT.FCVatRate, 0) AS FCVatRate, PDT_IMG.FTImgObj, PDT.FTPdtStaActive, PDT.FTPdtSetOrSN, 
	PDT.FTPgpChain, PDT.FTPtyCode, PDT_AGE.FCPdtCookTime, PDT_AGE.FCPdtCookHeat, ISNULL(PDT_L.FNLngID, 0) AS FNLngIDPdt, ISNULL(PDT_UNL.FNLngID, 0) AS FNLngIDUnit, PDT_PS.FTPunCode, PDT_UNL.FTPunName, 
	PDT_PS.FCPdtUnitFact, PSB.FTBchCode AS FTPdtSpcBch, PSB.FTMerCode, PSB.FTShpCode, PSB.FTMgpCode, PSB.FTAgnCode, SUBPDT_SPL.FTSplCode, SUBPDT_SPL.FTUsrCode AS FTBuyer, VBAR.FTBarCode, 
	PDT.FTPdtStaAlwDis, PDT.FTPdtType, VBAR.FTBarStaUse
...
dbo.VCN_ProductBar AS VBAR ON PDT.FTPdtCode = VBAR.FTPdtCode AND PDT_UNL.FTPunCode = VBAR.FTPunCode AND VBAR.FNLngPdtBar = PDT_L.FNLngID
GO

IF EXISTS (SELECT 1 FROM sys.views WHERE name='VCN_ProductsBranch' and type='v') DROP VIEW VCN_ProductsBranch
GO

CREATE VIEW VCN_ProductsBranch AS
SELECT	PDT.FTPdtCode, PDT_L.FTPdtName, PDT.FTPdtForSystem, PDT.FTPdtStaVatBuy, PDT.FTPdtStaVat, PDT.FTVatCode, ISNULL(VAT.FCVatRate, 0) AS FCVatRate, PDT_IMG.FTImgObj, PDT.FTPdtStaActive, PDT.FTPdtSetOrSN, 
PDT.FTPgpChain, PDT.FTPtyCode, PDT_AGE.FCPdtCookTime, PDT_AGE.FCPdtCookHeat, PDT_L.FNLngID AS FNLngIDPdt, PDT_UNL.FNLngID AS FNLngIDUnit, PDT_PS.FTPunCode, PDT_UNL.FTPunName, PDT_PS.FCPdtUnitFact,
PSB.FTBchCode AS FTPdtSpcBch, PSB.FTMerCode, PSB.FTShpCode, PSB.FTMgpCode, VBAR.FTSplCode, VBAR.FTUsrCode AS FTBuyer, VBAR.FTBarCode, PDT.FTPdtStaAlwDis, PSB.FTAgnCode, PDT.FTPdtType, VBAR.FTBarStaUse
FROM	dbo.TCNMPdt AS PDT LEFT OUTER JOIN
dbo.TCNMPdtSpcBch AS PSB ON PSB.FTPdtCode = PDT.FTPdtCode LEFT OUTER JOIN
dbo.TCNMPdt_L AS PDT_L ON PDT.FTPdtCode = PDT_L.FTPdtCode LEFT OUTER JOIN
dbo.TCNMPdtPackSize AS PDT_PS ON PDT.FTPdtCode = PDT_PS.FTPdtCode LEFT OUTER JOIN
...
IF EXISTS (SELECT 1 FROM sys.views WHERE name='VCN_ProductBar' and type='v') DROP VIEW VCN_ProductBar
GO

CREATE VIEW VCN_ProductBar AS
SELECT	PDT_BAR.FTPdtCode, PDT_L.FTPdtName, IMO.FTImgObj, PDT_BAR.FTPunCode, PDT_BAR.FTBarCode, PDT.FTVatCode, VAT.FCVatRate, PDT_L.FNLngID AS FNLngPdtBar, PDT_SPL.FTSplCode, PDT_BAR.FTPlcCode, 
	PLC.FTPlcName, PDT_SPL.FTUsrCode, PDT_BAR.FTBarStaUse
...
IF OBJECT_ID(N'TCNSEdcRcv') IS NULL BEGIN
	CREATE TABLE [dbo].[TCNSEdcRcv](
		[FTFmtCode] [varchar](5) NOT NULL,
		[FTSedCode] [varchar](3) NOT NULL,
		[FTErcType] [varchar](1) NOT NULL,
		[FTErcKey] [varchar](50) NOT NULL,
		[FTErcTransCode] [varchar](2) NOT NULL,
		[FNErcSeq] [bigint] NOT NULL,
		[FTErcFedType] [varchar](255) NULL,
		[FTErcValType] [varchar](255) NULL,
		[FNErcLenData] [bigint] NULL,
		[FTErcValue] [varchar](250) NULL,
	 CONSTRAINT [PK_TCNSEdcRcv] PRIMARY KEY CLUSTERED 
	(
		[FTFmtCode] ASC,
		[FTSedCode] ASC,
		[FTErcType] ASC,
	...
	EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'รหัสประเภทการชำระเงิน' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'TABLE',@level1name=N'TCNSEdcRcv', @level2type=N'COLUMN',@level2name=N'FTFmtCode'
	EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'รหัส Edc Model' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'TABLE',@level1name=N'TCNSEdcRcv', @level2type=N'COLUMN',@level2name=N'FTSedCode'
	EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'ประเภท 1:ขาย 2:คืน 3:สรุปยอด' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'TABLE',@level1name=N'TCNSEdcRcv', @level2type=N'COLUMN',@level2name=N'FTErcType'
	EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'กำหนด Key สำหรับตรวจสอบ' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'TABLE',@level1name=N'TCNSEdcRcv', @level2type=N'COLUMN',@level2name=N'FTErcKey'
	EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'รหัส Transaction' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'TABLE',@level1name=N'TCNSEdcRcv', @level2type=N'COLUMN',@level2name=N'FTErcTransCode'
	EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'ลำดับรายการตาม TransCode' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'TABLE',@level1name=N'TCNSEdcRcv', @level2type=N'COLUMN',@level2name=N'FNErcSeq'
	EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'ประเภท Field' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'TABLE',@level1name=N'TCNSEdcRcv', @level2type=N'COLUMN',@level2name=N'FTErcFedType'
	EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'ประเภทข้อมูล 1:GetValue ,2:Fix Value' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'TABLE',@level1name=N'TCNSEdcRcv', @level2type=N'COLUMN',@level2name=N'FTErcValType'
	EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'ความกว้างของข้อมูล' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'TABLE',@level1name=N'TCNSEdcRcv', @level2type=N'COLUMN',@level2name=N'FNErcLenData'
	EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'ค่าของข้อมูล' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'TABLE',@level1name=N'TCNSEdcRcv', @level2type=N'COLUMN',@level2name=N'FTErcValue'
	EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'รหัส Edc Model' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'TABLE',@level1name=N'TSysEdc', @level2type=N'COLUMN',@level2name=N'FTSedCode'
	EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'ชื่อ Edc Model' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'TABLE',@level1name=N'TSysEdc', @level2type=N'COLUMN',@level2name=N'FTSedModel'
	EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'Ack Confirm  1:ใช้งาน ,2:ไม่ใช้งาน' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'TABLE',@level1name=N'TSysEdc', @level2type=N'COLUMN',@level2name=N'FNSedAck'
	EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'Version Dll 1:VB6 ,2:VB.Net' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'TABLE',@level1name=N'TSysEdc', @level2type=N'COLUMN',@level2name=N'FTSedDllVer'
	EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'Timeout(วินาที)' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'TABLE',@level1name=N'TSysEdc', @level2type=N'COLUMN',@level2name=N'FNSedTimeOut'
	EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'วันที่ปรับปรุงรายการล่าสุด' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'TABLE',@level1name=N'TSysEdc', @level2type=N'COLUMN',@level2name=N'FDLastUpdOn'
	EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'ผู้ปรับปรุงรายการล่าสุด' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'TABLE',@level1name=N'TSysEdc', @level2type=N'COLUMN',@level2name=N'FTLastUpdBy'
	EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'วันที่สร้างรายการ' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'TABLE',@level1name=N'TSysEdc', @level2type=N'COLUMN',@level2name=N'FDCreateOn'
	EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'ผู้สร้างรายการ' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'TABLE',@level1name=N'TSysEdc', @level2type=N'COLUMN',@level2name=N'FTCreateBy'
END
GO
TRUNCATE TABLE TCNSEdcRcv
INSERT [dbo].[TCNSEdcRcv] ([FTFmtCode], [FTSedCode], [FTErcType], [FTErcKey], [FTErcTransCode], [FNErcSeq], [FTErcFedType], [FTErcValType], [FNErcLenData], [FTErcValue]) VALUES (N'000', N'012', N'3', N'SETTLEMENT', N'50', 1, N'HN', N'2', 3, N'')
INSERT [dbo].[TCNSEdcRcv] ([FTFmtCode], [FTSedCode], [FTErcType], [FTErcKey], [FTErcTransCode], [FNErcSeq], [FTErcFedType], [FTErcValType], [FNErcLenData], [FTErcValue]) VALUES (N'000', N'013', N'3', N'SETTLEMENT', N'50', 1, N'HN', N'2', 3, N'   ')
INSERT [dbo].[TCNSEdcRcv] ([FTFmtCode], [FTSedCode], [FTErcType], [FTErcKey], [FTErcTransCode], [FNErcSeq], [FTErcFedType], [FTErcValType], [FNErcLenData], [FTErcValue]) VALUES (N'000', N'014', N'3', N'SETTLEMENT', N'50', 1, N'HN', N'2', 3, N'   ')
INSERT [dbo].[TCNSEdcRcv] ([FTFmtCode], [FTSedCode], [FTErcType], [FTErcKey], [FTErcTransCode], [FNErcSeq], [FTErcFedType], [FTErcValType], [FNErcLenData], [FTErcValue]) VALUES (N'002', N'012', N'1', N'AMOUNT', N'20', 1, N'40', N'1', 12, N'')
INSERT [dbo].[TCNSEdcRcv] ([FTFmtCode], [FTSedCode], [FTErcType], [FTErcKey], [FTErcTransCode], [FNErcSeq], [FTErcFedType], [FTErcValType], [FNErcLenData], [FTErcValue]) VALUES (N'002', N'012', N'2', N'VOID', N'26', 1, N'65', N'1', 6, N'')
INSERT [dbo].[TCNSEdcRcv] ([FTFmtCode], [FTSedCode], [FTErcType], [FTErcKey], [FTErcTransCode], [FNErcSeq], [FTErcFedType], [FTErcValType], [FNErcLenData], [FTErcValue]) VALUES (N'002', N'013', N'1', N'AMOUNT', N'20', 1, N'40', N'1', 12, N'')
INSERT [dbo].[TCNSEdcRcv] ([FTFmtCode], [FTSedCode], [FTErcType], [FTErcKey], [FTErcTransCode], [FNErcSeq], [FTErcFedType], [FTErcValType], [FNErcLenData], [FTErcValue]) VALUES (N'002', N'013', N'2', N'VOID', N'26', 1, N'65', N'1', 6, N'')
INSERT [dbo].[TCNSEdcRcv] ([FTFmtCode], [FTSedCode], [FTErcType], [FTErcKey], [FTErcTransCode], [FNErcSeq], [FTErcFedType], [FTErcValType], [FNErcLenData], [FTErcValue]) VALUES (N'002', N'014', N'1', N'AMOUNT', N'20', 1, N'40', N'1', 12, N'')
INSERT [dbo].[TCNSEdcRcv] ([FTFmtCode], [FTSedCode], [FTErcType], [FTErcKey], [FTErcTransCode], [FNErcSeq], [FTErcFedType], [FTErcValType], [FNErcLenData], [FTErcValue]) VALUES (N'002', N'014', N'2', N'VOID', N'26', 1, N'65', N'1', 6, N'')
INSERT [dbo].[TCNSEdcRcv] ([FTFmtCode], [FTSedCode], [FTErcType], [FTErcKey], [FTErcTransCode], [FNErcSeq], [FTErcFedType], [FTErcValType], [FNErcLenData], [FTErcValue]) VALUES (N'009', N'012', N'1', N'AMOUNT', N'22', 1, N'40', N'1', 12, N'')
INSERT [dbo].[TCNSEdcRcv] ([FTFmtCode], [FTSedCode], [FTErcType], [FTErcKey], [FTErcTransCode], [FNErcSeq], [FTErcFedType], [FTErcValType], [FNErcLenData], [FTErcValue]) VALUES (N'009', N'012', N'1', N'IPPTerm', N'22', 3, N'N2', N'1', 2, N'')
INSERT [dbo].[TCNSEdcRcv] ([FTFmtCode], [FTSedCode], [FTErcType], [FTErcKey], [FTErcTransCode], [FNErcSeq], [FTErcFedType], [FTErcValType], [FNErcLenData], [FTErcValue]) VALUES (N'009', N'012', N'1', N'IPPType', N'22', 2, N'N1', N'2', 2, N'01')
INSERT [dbo].[TCNSEdcRcv] ([FTFmtCode], [FTSedCode], [FTErcType], [FTErcKey], [FTErcTransCode], [FNErcSeq], [FTErcFedType], [FTErcValType], [FNErcLenData], [FTErcValue]) VALUES (N'009', N'012', N'1', N'PDTModelNo', N'22', 6, N'N9', N'2', 6, N'999999')
INSERT [dbo].[TCNSEdcRcv] ([FTFmtCode], [FTSedCode], [FTErcType], [FTErcKey], [FTErcTransCode], [FNErcSeq], [FTErcFedType], [FTErcValType], [FNErcLenData], [FTErcValue]) VALUES (N'009', N'012', N'1', N'PDTSerial', N'22', 7, N'N6', N'2', 20, N'')
INSERT [dbo].[TCNSEdcRcv] ([FTFmtCode], [FTSedCode], [FTErcType], [FTErcKey], [FTErcTransCode], [FNErcSeq], [FTErcFedType], [FTErcValType], [FNErcLenData], [FTErcValue]) VALUES (N'009', N'012', N'1', N'PDTType', N'22', 5, N'N8', N'2', 3, N'999')
INSERT [dbo].[TCNSEdcRcv] ([FTFmtCode], [FTSedCode], [FTErcType], [FTErcKey], [FTErcTransCode], [FNErcSeq], [FTErcFedType], [FTErcValType], [FNErcLenData], [FTErcValue]) VALUES (N'009', N'012', N'1', N'SPL', N'22', 4, N'N7', N'2', 5, N'99999')
INSERT [dbo].[TCNSEdcRcv] ([FTFmtCode], [FTSedCode], [FTErcType], [FTErcKey], [FTErcTransCode], [FNErcSeq], [FTErcFedType], [FTErcValType], [FNErcLenData], [FTErcValue]) VALUES (N'009', N'012', N'2', N'VOID', N'26', 1, N'65', N'1', 6, N'')
INSERT [dbo].[TCNSEdcRcv] ([FTFmtCode], [FTSedCode], [FTErcType], [FTErcKey], [FTErcTransCode], [FNErcSeq], [FTErcFedType], [FTErcValType], [FNErcLenData], [FTErcValue]) VALUES (N'009', N'014', N'1', N'AMOUNT', N'22', 1, N'40', N'1', 12, N'')
INSERT [dbo].[TCNSEdcRcv] ([FTFmtCode], [FTSedCode], [FTErcType], [FTErcKey], [FTErcTransCode], [FNErcSeq], [FTErcFedType], [FTErcValType], [FNErcLenData], [FTErcValue]) VALUES (N'009', N'014', N'1', N'PDTModelNo', N'22', 5, N'N9', N'2', 6, N'999999')
INSERT [dbo].[TCNSEdcRcv] ([FTFmtCode], [FTSedCode], [FTErcType], [FTErcKey], [FTErcTransCode], [FNErcSeq], [FTErcFedType], [FTErcValType], [FNErcLenData], [FTErcValue]) VALUES (N'009', N'014', N'1', N'PDTSerial', N'22', 2, N'N6', N'2', 20, N'')
INSERT [dbo].[TCNSEdcRcv] ([FTFmtCode], [FTSedCode], [FTErcType], [FTErcKey], [FTErcTransCode], [FNErcSeq], [FTErcFedType], [FTErcValType], [FNErcLenData], [FTErcValue]) VALUES (N'009', N'014', N'1', N'PDTType', N'22', 4, N'N8', N'2', 3, N'999')
INSERT [dbo].[TCNSEdcRcv] ([FTFmtCode], [FTSedCode], [FTErcType], [FTErcKey], [FTErcTransCode], [FNErcSeq], [FTErcFedType], [FTErcValType], [FNErcLenData], [FTErcValue]) VALUES (N'009', N'014', N'1', N'SPL', N'22', 3, N'N7', N'2', 5, N'99999')
INSERT [dbo].[TCNSEdcRcv] ([FTFmtCode], [FTSedCode], [FTErcType], [FTErcKey], [FTErcTransCode], [FNErcSeq], [FTErcFedType], [FTErcValType], [FNErcLenData], [FTErcValue]) VALUES (N'009', N'014', N'2', N'VOID', N'26', 1, N'65', N'1', 6, N'')
INSERT [dbo].[TCNSEdcRcv] ([FTFmtCode], [FTSedCode], [FTErcType], [FTErcKey], [FTErcTransCode], [FNErcSeq], [FTErcFedType], [FTErcValType], [FNErcLenData], [FTErcValue]) VALUES (N'012', N'012', N'1', N'AMOUNT', N'D4', 1, N'40', N'1', 12, N'')
INSERT [dbo].[TCNSEdcRcv] ([FTFmtCode], [FTSedCode], [FTErcType], [FTErcKey], [FTErcTransCode], [FNErcSeq], [FTErcFedType], [FTErcValType], [FNErcLenData], [FTErcValue]) VALUES (N'012', N'012', N'1', N'TYPE', N'D4', 2, N'66', N'2', 1, N'A')
INSERT [dbo].[TCNSEdcRcv] ([FTFmtCode], [FTSedCode], [FTErcType], [FTErcKey], [FTErcTransCode], [FNErcSeq], [FTErcFedType], [FTErcValType], [FNErcLenData], [FTErcValue]) VALUES (N'012', N'012', N'2', N'VOID', N'26', 1, N'65', N'1', 6, N'')
INSERT [dbo].[TCNSEdcRcv] ([FTFmtCode], [FTSedCode], [FTErcType], [FTErcKey], [FTErcTransCode], [FNErcSeq], [FTErcFedType], [FTErcValType], [FNErcLenData], [FTErcValue]) VALUES (N'012', N'013', N'1', N'AMOUNT', N'70', 1, N'40', N'1', 12, N'')
INSERT [dbo].[TCNSEdcRcv] ([FTFmtCode], [FTSedCode], [FTErcType], [FTErcKey], [FTErcTransCode], [FNErcSeq], [FTErcFedType], [FTErcValType], [FNErcLenData], [FTErcValue]) VALUES (N'012', N'013', N'1', N'TYPE', N'70', 2, N'A1', N'2', 2, N'01')
INSERT [dbo].[TCNSEdcRcv] ([FTFmtCode], [FTSedCode], [FTErcType], [FTErcKey], [FTErcTransCode], [FNErcSeq], [FTErcFedType], [FTErcValType], [FNErcLenData], [FTErcValue]) VALUES (N'012', N'013', N'2', N'VOID', N'26', 1, N'65', N'1', 6, N'')
INSERT [dbo].[TCNSEdcRcv] ([FTFmtCode], [FTSedCode], [FTErcType], [FTErcKey], [FTErcTransCode], [FNErcSeq], [FTErcFedType], [FTErcValType], [FNErcLenData], [FTErcValue]) VALUES (N'012', N'014', N'1', N'AMOUNT', N'D4', 1, N'40', N'1', 12, N'')
INSERT [dbo].[TCNSEdcRcv] ([FTFmtCode], [FTSedCode], [FTErcType], [FTErcKey], [FTErcTransCode], [FNErcSeq], [FTErcFedType], [FTErcValType], [FNErcLenData], [FTErcValue]) VALUES (N'012', N'014', N'1', N'TYPE', N'D4', 2, N'66', N'2', 1, N'A')
INSERT [dbo].[TCNSEdcRcv] ([FTFmtCode], [FTSedCode], [FTErcType], [FTErcKey], [FTErcTransCode], [FNErcSeq], [FTErcFedType], [FTErcValType], [FNErcLenData], [FTErcValue]) VALUES (N'012', N'014', N'2', N'VOID', N'26', 1, N'65', N'1', 6, N'')
INSERT [dbo].[TCNSEdcRcv] ([FTFmtCode], [FTSedCode], [FTErcType], [FTErcKey], [FTErcTransCode], [FNErcSeq], [FTErcFedType], [FTErcValType], [FNErcLenData], [FTErcValue]) VALUES (N'013', N'012', N'1', N'AMOUNT', N'D3', 1, N'40', N'1', 12, N'')
INSERT [dbo].[TCNSEdcRcv] ([FTFmtCode], [FTSedCode], [FTErcType], [FTErcKey], [FTErcTransCode], [FNErcSeq], [FTErcFedType], [FTErcValType], [FNErcLenData], [FTErcValue]) VALUES (N'013', N'012', N'1', N'TYPE', N'D3', 2, N'66', N'2', 1, N'P')
INSERT [dbo].[TCNSEdcRcv] ([FTFmtCode], [FTSedCode], [FTErcType], [FTErcKey], [FTErcTransCode], [FNErcSeq], [FTErcFedType], [FTErcValType], [FNErcLenData], [FTErcValue]) VALUES (N'013', N'012', N'2', N'VOID', N'26', 1, N'65', N'1', 6, N'')
INSERT [dbo].[TCNSEdcRcv] ([FTFmtCode], [FTSedCode], [FTErcType], [FTErcKey], [FTErcTransCode], [FNErcSeq], [FTErcFedType], [FTErcValType], [FNErcLenData], [FTErcValue]) VALUES (N'013', N'013', N'1', N'AMOUNT', N'70', 1, N'40', N'1', 12, N'')
INSERT [dbo].[TCNSEdcRcv] ([FTFmtCode], [FTSedCode], [FTErcType], [FTErcKey], [FTErcTransCode], [FNErcSeq], [FTErcFedType], [FTErcValType], [FNErcLenData], [FTErcValue]) VALUES (N'013', N'013', N'1', N'TYPE', N'70', 2, N'A1', N'2', 2, N'03')
INSERT [dbo].[TCNSEdcRcv] ([FTFmtCode], [FTSedCode], [FTErcType], [FTErcKey], [FTErcTransCode], [FNErcSeq], [FTErcFedType], [FTErcValType], [FNErcLenData], [FTErcValue]) VALUES (N'013', N'013', N'2', N'VOID', N'26', 1, N'65', N'1', 6, N'')
INSERT [dbo].[TCNSEdcRcv] ([FTFmtCode], [FTSedCode], [FTErcType], [FTErcKey], [FTErcTransCode], [FNErcSeq], [FTErcFedType], [FTErcValType], [FNErcLenData], [FTErcValue]) VALUES (N'013', N'014', N'1', N'AMOUNT', N'D3', 1, N'40', N'1', 12, N'')
INSERT [dbo].[TCNSEdcRcv] ([FTFmtCode], [FTSedCode], [FTErcType], [FTErcKey], [FTErcTransCode], [FNErcSeq], [FTErcFedType], [FTErcValType], [FNErcLenData], [FTErcValue]) VALUES (N'013', N'014', N'1', N'TYPE', N'D3', 2, N'66', N'2', 1, N'P')
INSERT [dbo].[TCNSEdcRcv] ([FTFmtCode], [FTSedCode], [FTErcType], [FTErcKey], [FTErcTransCode], [FNErcSeq], [FTErcFedType], [FTErcValType], [FNErcLenData], [FTErcValue]) VALUES (N'013', N'014', N'2', N'VOID', N'26', 1, N'65', N'1', 6, N'')
INSERT [dbo].[TCNSEdcRcv] ([FTFmtCode], [FTSedCode], [FTErcType], [FTErcKey], [FTErcTransCode], [FNErcSeq], [FTErcFedType], [FTErcValType], [FNErcLenData], [FTErcValue]) VALUES (N'016', N'012', N'1', N'AMOUNT', N'D4', 1, N'40', N'1', 12, N'')
INSERT [dbo].[TCNSEdcRcv] ([FTFmtCode], [FTSedCode], [FTErcType], [FTErcKey], [FTErcTransCode], [FNErcSeq], [FTErcFedType], [FTErcValType], [FNErcLenData], [FTErcValue]) VALUES (N'016', N'012', N'1', N'TYPE', N'D4', 2, N'66', N'2', 1, N'W')
INSERT [dbo].[TCNSEdcRcv] ([FTFmtCode], [FTSedCode], [FTErcType], [FTErcKey], [FTErcTransCode], [FNErcSeq], [FTErcFedType], [FTErcValType], [FNErcLenData], [FTErcValue]) VALUES (N'016', N'012', N'2', N'VOID', N'26', 1, N'65', N'1', 6, N'')
INSERT [dbo].[TCNSEdcRcv] ([FTFmtCode], [FTSedCode], [FTErcType], [FTErcKey], [FTErcTransCode], [FNErcSeq], [FTErcFedType], [FTErcValType], [FNErcLenData], [FTErcValue]) VALUES (N'016', N'013', N'1', N'AMOUNT', N'70', 1, N'40', N'1', 12, N'')
INSERT [dbo].[TCNSEdcRcv] ([FTFmtCode], [FTSedCode], [FTErcType], [FTErcKey], [FTErcTransCode], [FNErcSeq], [FTErcFedType], [FTErcValType], [FNErcLenData], [FTErcValue]) VALUES (N'016', N'013', N'1', N'TYPE', N'70', 2, N'A1', N'2', 2, N'02')
INSERT [dbo].[TCNSEdcRcv] ([FTFmtCode], [FTSedCode], [FTErcType], [FTErcKey], [FTErcTransCode], [FNErcSeq], [FTErcFedType], [FTErcValType], [FNErcLenData], [FTErcValue]) VALUES (N'016', N'013', N'2', N'VOID', N'26', 1, N'65', N'1', 6, N'')
INSERT [dbo].[TCNSEdcRcv] ([FTFmtCode], [FTSedCode], [FTErcType], [FTErcKey], [FTErcTransCode], [FNErcSeq], [FTErcFedType], [FTErcValType], [FNErcLenData], [FTErcValue]) VALUES (N'016', N'014', N'1', N'AMOUNT', N'D4', 1, N'40', N'1', 12, N'')
INSERT [dbo].[TCNSEdcRcv] ([FTFmtCode], [FTSedCode], [FTErcType], [FTErcKey], [FTErcTransCode], [FNErcSeq], [FTErcFedType], [FTErcValType], [FNErcLenData], [FTErcValue]) VALUES (N'016', N'014', N'1', N'TYPE', N'D4', 2, N'66', N'2', 1, N'W')
INSERT [dbo].[TCNSEdcRcv] ([FTFmtCode], [FTSedCode], [FTErcType], [FTErcKey], [FTErcTransCode], [FNErcSeq], [FTErcFedType], [FTErcValType], [FNErcLenData], [FTErcValue]) VALUES (N'016', N'014', N'2', N'VOID', N'26', 1, N'65', N'1', 6, N'')
GO
IF NOT EXISTS(SELECT FTSedCode FROM TSysEdc WHERE FTSedCode = '011') BEGIN
	INSERT [dbo].[TSysEdc] ([FTSedCode], [FTSedModel], [FNSedAck], [FTSedDllVer], [FNSedTimeOut], [FDLastUpdOn], [FTLastUpdBy], [FDCreateOn], [FTCreateBy]) 
	VALUES (N'011', N'CASTLES', 1, N'2', 120, CAST(N'2022-09-20T00:00:00.000' AS DateTime), N'Junthon M.', CAST(N'2022-09-20T00:00:00.000' AS DateTime), N'Junthon M.')
END
GO
IF NOT EXISTS(SELECT FTSedCode FROM TSysEdc WHERE FTSedCode = '012') BEGIN
	INSERT [dbo].[TSysEdc] ([FTSedCode], [FTSedModel], [FNSedAck], [FTSedDllVer], [FNSedTimeOut], [FDLastUpdOn], [FTLastUpdBy], [FDCreateOn], [FTCreateBy]) 
	VALUES (N'012', N'VerifoneX990', 1, N'2', 120, CAST(N'2022-09-20T00:00:00.000' AS DateTime), N'Junthon M.', CAST(N'2022-09-20T00:00:00.000' AS DateTime), N'Junthon M.')
END
GO
IF NOT EXISTS(SELECT FTSedCode FROM TSysEdc WHERE FTSedCode = '013') BEGIN
	INSERT [dbo].[TSysEdc] ([FTSedCode], [FTSedModel], [FNSedAck], [FTSedDllVer], [FNSedTimeOut], [FDLastUpdOn], [FTLastUpdBy], [FDCreateOn], [FTCreateBy]) 
	VALUES (N'013', N'IngenicoAPOSA8', 1, N'2', 120, CAST(N'2022-09-20T00:00:00.000' AS DateTime), N'Junthon M.', CAST(N'2022-09-20T00:00:00.000' AS DateTime), N'Junthon M.')
END
GO
IF NOT EXISTS(SELECT FTSedCode FROM TSysEdc WHERE FTSedCode = '014') BEGIN
	INSERT [dbo].[TSysEdc] ([FTSedCode], [FTSedModel], [FNSedAck], [FTSedDllVer], [FNSedTimeOut], [FDLastUpdOn], [FTLastUpdBy], [FDCreateOn], [FTCreateBy]) 
	VALUES (N'014', N'VerifoneX990Installment', 1, N'2', 120, CAST(N'2022-12-08T00:00:00.000' AS DateTime), N'Junthon M.', CAST(N'2022-12-08T00:00:00.000' AS DateTime), N'Junthon M.')
END

--############################################################################################

-- พี่หนุ่ยเพิ่มฟิวส์เก็บ FTXphDocType (รอ deploy version 07.01.00)
-- if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].TRPTAdjPriceTmp'))
-- 	DROP TABLE TRPTAdjPriceTmp
-- GO
-- CREATE TABLE [dbo].[TRPTAdjPriceTmp](
-- 	[FTRptRowSeq] [bigint] IDENTITY(1,1) NOT NULL,
...
-- ALTER TABLE [dbo].[TRPTAdjPriceTmp] ADD  DEFAULT (getdate()) FOR [FDTmpTxnDate]
-- GO