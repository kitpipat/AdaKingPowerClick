                ...
                <table class="table">
                    <thead>
                        <tr>
                            ...
                            <th nowrap class="text-right xCNRptColumnHeader" style="width:25%;"><?php echo $aDataTextRef['tRptEndDaySaleQTY']; ?></th>
                            <th nowrap class="text-right xCNRptColumnHeader" style="width:25%;"><?php echo $aDataTextRef['tRptEndDaySaleSum']; ?></th>
                        </tr>
                    </thead>
                    <tbody>
                        ...
                        ?>
                                ...
                                <tr>
                                    ...
                                    <?php if ($aValue["FTXihValType"] == '5') { ?>
                                        <td class="text-left xCNRptDetail">
                                            ...
                                            if ($aValue['FTXihValType'] != '') {
                                                if ($aValue["FTRcvCode"] != '') {
                                                    echo '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;' . '(' . $aValue["FTRcvRefNo1"] . ') ' . $aValue["FTRcvRefNo2"];
                                                } else {
                                        ...
                                        if ($aValue['FTXihValType'] != '') {
                                            if ($aValue["FTRcvCode"] != '') { ?>
                                                <td class="text-right xCNRptDetail"><?php echo number_format($aValue["FNRcvUseAmt"], 0); ?></td>
                                            <?php
                                            } else { ?>
                                                <td class="text-right xCNRptDetail"></td>
                                        <?php    }
                                    ...
                                    <?php if ($aValue["FTXihValType"] == '8') { ?>
                                        ...
                                        if ($aValue['FTXihValType'] != '') {
                                            if ($aValue["FTRcvCode"] != '') { ?>
                                                <td class="text-right xCNRptDetail" style='border-bottom: dashed 1px #333 !important;'></td>
                                            <?php
                                            } else { ?>
                                                <td class="text-right xCNRptDetail" style='border-bottom: dashed 1px #333 !important;'></td>
                                        <?php    }
                            ...
                            if ($nPageNo == $nTotalPage) {
                                echo "<tr'>";
                                echo "<td class='xCNRptSumFooter text-left' style='border-top: 0px solid black !important;border-bottom: 1px solid black !important;'>รวมจำนวนครั้งการใช้</td>";
                                echo "<td class='xCNRptSumFooter text-right' style='border-top: 0px solid black !important;border-bottom: 1px solid black !important;'>" . number_format($tFooterValUse2, 0) . "</td>";
                                echo "<td class='xCNRptSumFooter text-right' style='border-top: 0px solid black !important;border-bottom: 1px solid black !important;'></td>";
                            }
                            echo "<tr>";
                            ?>
                            <?php
                            ...
                            if ($nPageNo == $nTotalPage) {
                                echo "<tr'>";
                                echo "<td class='xCNRptSumFooter text-left' style='border-top: 0px solid black !important;border-bottom: 1px solid black !important;'>รวมจำนวนบิล</td>";
                                echo "<td class='xCNRptSumFooter text-right' style='border-top: 0px solid black !important;border-bottom: 1px solid black !important;'>" . number_format($aValue['FNBillSalTotal'], 0) . "</td>";
                                echo "<td class='xCNRptSumFooter text-right' style='border-top: 0px solid black !important;border-bottom: 1px solid black !important;'></td>";
                            }
                            echo "<tr>";
                            ?>
