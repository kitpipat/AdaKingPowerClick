        ...
        $tSQL   = " SELECT
                    ...
                    FROM (
                        ...
                        LEFT JOIN (
                            ...
                            AND FTUsrSession    = '$tSession'
                            GROUP BY FTPdtCode
                        ) DATASUBPDT ON 1=1   AND DATASTKCRD.FTPdtCode = DATASUBPDT.FTPdtCode_SUBPDT
                        -- LEFT JOIN (
                        --     SELECT DISTINCT
                        ...
                        --     AND FTUsrSession    = '$tSession'
                        --     GROUP BY FTPdtCode
                        -- ) DATASUBWAH ON 1=1 AND DATASTKCRD.FTPdtCode	= DATASUBWAH.FTPdtCode_SUBWAH 
                        -- LEFT JOIN (
                        --     SELECT DISTINCT
                        ...
                        --     AND FTUsrSession    = '$tSession'
                        --     GROUP BY FTPdtCode
                        -- ) DATASUBBCH ON 1=1 AND DATASTKCRD.FTPdtCode	= DATASUBWAH.FTPdtCode_SUBWAH 
                        WHERE DATASTKCRD.FTComName		= '$tComName'
