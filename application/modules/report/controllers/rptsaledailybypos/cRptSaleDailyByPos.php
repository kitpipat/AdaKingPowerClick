...
class cRptSaleDailyByPos extends MX_Controller
{
    /**
     * ภาษา
     * @var array
    ...
    public function __construct(){
        ...
        $this->load->model('report/rptsaledailybypos/mRptSaleDailyByPos');
    ...
    public function index(){
        if (!empty($this->tRptCode) && !empty($this->tRptExportType)) {
            ...
            $this->mRptSaleDailyByPos->FSnMExecStoreReport($this->aRptFilter);
    ...
    public function FSvCCallRptViewBeforePrint(){
        try {
            ...
            //Get Data
            $aDataReport = $this->mRptSaleDailyByPos->FSaMGetDataReport($aDataReportParams);
    ...
    public function FSvCCallRptViewBeforePrintClickPage(){
        ...
        //Get Data
        $aDataReport = $this->mRptSaleDailyByPos->FSaMGetDataReport($aDataWhere, $aDataFilter);
    ...
    public function FSoCChkDataReportInTableTemp(){
        try {
            ...
            $nDataCountPage = $this->mRptSaleDailyByPos->FSnMCountRowInTemp($aDataCountData);
