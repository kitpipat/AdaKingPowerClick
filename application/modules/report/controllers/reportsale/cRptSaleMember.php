...
class cRptSaleMember extends MX_Controller{
        /**
     * ภาษา
     * @var array
     */
    ...
    public function __construct() {
        ...
        $this->load->model('report/reportsale/mRptSaleMember');
    ...
    public function index() {
        if (!empty($this->tRptCode) && !empty($this->tRptExportType)) {
            ...
            $this->mRptSaleMember->FSnMExecStoreReport($this->aRptFilter);
            ...
            // // //  // Count Rows
             ...
             $this->nRows = $this->mRptSaleMember->FSnMCountRowInTemp($aCountRowParams);
    ...
    public function FSvCCallRptViewBeforePrint(){
        try{
            ...
            //Get Data
            $aDataReport = $this->mRptSaleMember->FSaMGetDataReport($aDataReportParams);
    ...
    public function FSvCCallRptViewBeforePrintClickPage(){
        ...
        //Get Data
        $aDataReport = $this->mRptSaleMember->FSaMGetDataReport($aDataWhere, $aDataFilter);

        // GetDataSumFootReport
        // $aDataSumFoot = $this->mRptSaleMember->FSaMGetDataSumFootReport($aDataWhere, $aDataFilter);
    ...
    public function FSoCChkDataReportInTableTemp(){
        try{
            ...
            $nDataCountPage     = $this->mRptSaleMember->FSnMCountRowInTemp($aDataCountData);
