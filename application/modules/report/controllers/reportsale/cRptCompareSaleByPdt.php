...
class cRptCompareSaleByPdt extends MX_Controller
{
    ...
    public function __construct()
    {
        ...
        $this->load->model('report/reportsale/mRptCompareSaleByPdt');
    ...
    {
        $this->aText = [
            'tTitleReport'       => language('report/report/report', 'tRptCompareSaleByPdtTitleMTD'),
            ...
            'tRptProductCode'       => language('report/report/report', 'tRptProductCode'), //รหัสสินค้า
            'tRptProductName'       => language('report/report/report', 'tRptProductName'), //ชื่อสินค้า
            'tRptProduct'           => language('report/report/report', 'tRptProduct'),

            'tRptQty'               => language('report/report/report', 'tRptQty'),  //Qty
            'tRptCompareLastYear'   => language('report/report/report', 'tRptCompareLastYear'), // Last year
            'tRptCompareThisYear'   => language('report/report/report', 'tRptCompareThisYear'), // This year
            'tRptMTDLM'             => language('report/report/report', 'tRptMTDLM'), //MTD LM
            'tRptMTD'               => language('report/report/report', 'tRptMTD'), // MTD
            'tRptCompareQty'        => language('report/report/report', 'tRptCompareQty'), // Compare Qty
            'tRptPerCen'            => language('report/report/report', 'tRptPerCen'), //%
            'tRptCompareLY'         => language('report/report/report', 'tRptCompareLY'), //Compare LY
            'tRptDiff'              => language('report/report/report', 'tRptDiff'), // Diff
            'tRptAmt'               => language('report/report/report', 'tRptAmt'),  //Amt
    ...
    public function index()
    {
        if (!empty($this->tRptExportType) && !empty($this->tRptCode)) {
            ...
            $this->mRptCompareSaleByPdt->FSnMExecStoreReport($this->aRptFilter);
    ...
    public function FSvCCallRptViewBeforePrint()
    {
        ...
        $aDataReport = $this->mRptCompareSaleByPdt->FSaMGetDataReport($aDataWhereRpt);
        ...
        $tRptView = JCNoHLoadViewAdvanceTable('report/datasources/reportsale/rptCompareSaleByPdt', 'wRpCompareSaleByPdtHtml', $aDataViewRpt);
    ...
    public function FSvCCallRptViewBeforePrintClickPage()
    {
        ...
        $aDataReport = $this->mRptCompareSaleByPdt->FSaMGetDataReport($aDataReportParams);
        ...
        // Load View Advance Table
        $tRptView = JCNoHLoadViewAdvanceTable('report/datasources/reportsale/rptCompareSaleByPdt', 'wRpCompareSaleByPdtHtml', $aDataViewRptParams);
    ...
    public function FSvCCallRptRenderExcel()
    {
        ...
        $aCells = [
            ...
            WriterEntityFactory::createCell(null),
            WriterEntityFactory::createCell(null),
            WriterEntityFactory::createCell(language('report/report/report', 'tRptAmt')),
            WriterEntityFactory::createCell(null),
            WriterEntityFactory::createCell(null),
            WriterEntityFactory::createCell(null),
            WriterEntityFactory::createCell(null),
        ...
        $aCells = [
            ...
            WriterEntityFactory::createCell(null),
            WriterEntityFactory::createCell(null),
            WriterEntityFactory::createCell(language('report/report/report', 'tRptCompareLastYear')),
            WriterEntityFactory::createCell(null),
            WriterEntityFactory::createCell(null),
            WriterEntityFactory::createCell(null),
            WriterEntityFactory::createCell(language('report/report/report', 'tRptCompareThisYear')),
            WriterEntityFactory::createCell(null),
            WriterEntityFactory::createCell(null),
            WriterEntityFactory::createCell(null),
        ...
        $aCells = [
            ...
            WriterEntityFactory::createCell(null),
            WriterEntityFactory::createCell(language('report/report/report', 'tRptMTDLM')),
            WriterEntityFactory::createCell(language('report/report/report', 'tRptMTD')),
            WriterEntityFactory::createCell(language('report/report/report', 'tRptDiff')),
        ...
        if (isset($aDataReport['aRptData']) && !empty($aDataReport['aRptData'])) {
            foreach ($aDataReport['aRptData'] as $nKey => $aValue) {
                ...
                $values = [
                    ...
                    WriterEntityFactory::createCell(null),
                    WriterEntityFactory::createCell(FCNnGetNumeric($aValue['FCRptQtyMTD_LM_LY'])),
                    WriterEntityFactory::createCell(FCNnGetNumeric($aValue['FCRptQtyMTD_LY'])),
                    WriterEntityFactory::createCell(FCNnGetNumeric($aValue['FCRptQtyDiff_LY'])),
                    WriterEntityFactory::createCell(FCNnGetNumeric($aValue['FCRptQtyPercen_LY'])),
                    WriterEntityFactory::createCell(FCNnGetNumeric($aValue['FCRptQtyMTD_LM'])),
                    WriterEntityFactory::createCell(FCNnGetNumeric($aValue['FCRptQtyMTD'])),
                    WriterEntityFactory::createCell(FCNnGetNumeric($aValue['FCRptQtyDiff'])),
                    WriterEntityFactory::createCell(FCNnGetNumeric($aValue['FCRptQtyPercen'])),
                    ...
                    WriterEntityFactory::createCell(FCNnGetNumeric($aValue['FCRptAmtMTD_LM_LY'])),
                    WriterEntityFactory::createCell(FCNnGetNumeric($aValue['FCRptAmtMTD_LY'])),
                    WriterEntityFactory::createCell(FCNnGetNumeric($aValue['FCRptAmtvDiff_LY'])),
                    WriterEntityFactory::createCell(FCNnGetNumeric($aValue['FCRptAmtPercen_LY'])),
                    WriterEntityFactory::createCell(FCNnGetNumeric($aValue['FCRptAmtMTD_LM'])),
                    WriterEntityFactory::createCell(FCNnGetNumeric($aValue['FCRptAmtMTD'])),
                    WriterEntityFactory::createCell(FCNnGetNumeric($aValue['FCRptAmtDiff'])),
                    WriterEntityFactory::createCell(FCNnGetNumeric($aValue['FCRptAmtPercen'])),
                ...
                if (($nKey + 1) == FCNnHSizeOf($aDataReport['aRptData'])) { //SumFooter
                    ...
                    $values = [
                        ...
                        WriterEntityFactory::createCell(null),
                        WriterEntityFactory::createCell(null),
                        WriterEntityFactory::createCell(FCNnGetNumeric($aValue['FCRptQtyMTD_LM_LY_Footer'])),
                        WriterEntityFactory::createCell(FCNnGetNumeric($aValue['FCRptQtyMTD_LY_Footer'])),
                        WriterEntityFactory::createCell(FCNnGetNumeric($aValue['FCRptQtyDiff_LY_Footer'])),
                        WriterEntityFactory::createCell(FCNnGetNumeric($aValue['FCRptQtyPercen_LY_Footer'])),
                        WriterEntityFactory::createCell(FCNnGetNumeric($aValue['FCRptQtyMTD_LM_Footer'])),
                        WriterEntityFactory::createCell(FCNnGetNumeric($aValue['FCRptQtyMTD_Footer'])),
                        WriterEntityFactory::createCell(FCNnGetNumeric($aValue['FCRptQtyDiff_Footer'])),
                        WriterEntityFactory::createCell(FCNnGetNumeric($aValue['FCRptQtyPercen_Footer'])),
                        ...
                        WriterEntityFactory::createCell(FCNnGetNumeric($aValue['FCRptAmtMTD_LM_LY_Footer'])),
                        WriterEntityFactory::createCell(FCNnGetNumeric($aValue['FCRptAmtMTD_LY_Footer'])),
                        WriterEntityFactory::createCell(FCNnGetNumeric($aValue['FCRptAmtvDiff_LY_Footer'])),
                        WriterEntityFactory::createCell(FCNnGetNumeric($aValue['FCRptAmtPercen_LY_Footer'])),
                        WriterEntityFactory::createCell(FCNnGetNumeric($aValue['FCRptAmtMTD_LM_Footer'])),
                        WriterEntityFactory::createCell(FCNnGetNumeric($aValue['FCRptAmtMTD_Footer'])),
                        WriterEntityFactory::createCell(FCNnGetNumeric($aValue['FCRptAmtDiff_Footer'])),
                        WriterEntityFactory::createCell(FCNnGetNumeric($aValue['FCRptAmtPercen_Footer'])),
    ...
    // Return : String View
    // Return Type : View
    public function FSvCDSHSALMainPageReport($ptCode = NULL)
    {
        if ($ptCode == 'defult') {
            $tWhereSPC = "";
        ...
        // // ยอดขายตามประเภทสินค้า   fortest
        // $tFileTotalSaleByPdtPty = APPPATH . "modules\sale\assets\sysdshtemp\\" . $this->tSesUserCode . "\\db_totalsaleRptCpmPdt_tmp.txt";
        ...
        // $aDataTotalSaleByPdtPty = $this->mRptCompareSaleByPdt->FSaMGetDataReportAmt($aDataWhereRpt);


        // $oFileTotalSaelByPdtPty = fopen($tFileTotalSaleByPdtPty, 'w');
        // rewind($oFileTotalSaelByPdtPty);
        // fwrite($oFileTotalSaelByPdtPty, json_encode($aDataTotalSaleByPdtPty['aRptData']));
        ...
        // $tRptView = JCNoHLoadViewAdvanceTable('report/datasources/reportsale/rptCompareSaleByPdt', 'wRpCompareSaleByPdtHtml', $aDataConfigView);


        $tFileTotalSaleByPdtGrp = APPPATH . "modules\sale\assets\sysdshtemp\\" . $this->session->userdata("tSesUserCode")  . "\\db_totalsaleRptCpmPdt_tmp.txt";
        ...
        $aDataTotalSaleByPdtPty = $this->mRptCompareSaleByPdt->FSaMGetDataReportAmt($aDataReportParams);
        ...
        fwrite($oFileTotalSaleByPdtGrp, json_encode($aDataTotalSaleByPdtPty['aRptData']));
        fclose($oFileTotalSaleByPdtGrp);


        $tFilesOpenPath = APPPATH . "modules\sale\assets\sysdshtemp\\" . $this->tSesUserCode . "\\db_totalsaleRptCpmPdt_tmp.txt";
        $oFilesOpen     = fopen($tFilesOpenPath, 'r');
        $aDataFiles     = json_decode(fread($oFilesOpen, filesize($tFilesOpenPath)), true);
        fclose($oFilesOpen);

        require_once APPPATH . 'modules\sale\datasources\charttotalRptComparePdt\rChartTotalRptComparePdt.php';
        $oChartTotalRptComparePdt    = new rChartTotalRptComparePdt(array(
            'aDataReturn'   => $aDataFiles,
            'aTextLang'     => $this->aTextLang
        ));

        $oChartTotalRptComparePdt->run();

        $tHtmlViewChart     = $oChartTotalRptComparePdt->render('wChartTotalSaleComparePdt', true);
        $aDataConfigView    = [
    ...
    // Return : String View
    // Return Type : View
    public function FSvCDSHSALMainPageReportQty($ptCode = NULL)
    {
        ...
        // // ยอดขายตามประเภทสินค้า   fortest
        // $tFileTotalSaleByPdtPty = APPPATH . "modules\sale\assets\sysdshtemp\\" . $this->tSesUserCode . "\\db_totalsaleRptCpmPdtQty_tmp.txt";
        ...
        // $aDataTotalSaleByPdtPty = $this->mRptCompareSaleByPdt->FSaMGetDataReportQty($aDataWhereRpt);

        // // print_r($aDataTotalSaleByPdtPty);
        ...
        $tFileTotalSaleByPdtGrp = APPPATH . "modules\sale\assets\sysdshtemp\\" . $this->session->userdata("tSesUserCode")  . "\\db_totalsaleRptCpmPdtQty_tmp.txt";
        ...
        $aDataTotalSaleByPdtPty = $this->mRptCompareSaleByPdt->FSaMGetDataReportQty($aDataReportParams);
        // print_r($aDataTotalSaleByPdtGrp['aRptData']);  die();
        // print_r(json_encode($aDataTotalSaleByPdtGrp['aRptData'])); die();
        $oFileTotalSaleByPdtGrp = fopen($tFileTotalSaleByPdtGrp, 'w');
        rewind($oFileTotalSaleByPdtGrp);
        ...
        $tFilesOpenPath = APPPATH . "modules\sale\assets\sysdshtemp\\" . $this->tSesUserCode . "\\db_totalsaleRptCpmPdtQty_tmp.txt";
        $oFilesOpen     = fopen($tFilesOpenPath, 'r');
        $aDataFiles     = json_decode(fread($oFilesOpen, filesize($tFilesOpenPath)), true);
        fclose($oFilesOpen);

        require_once APPPATH . 'modules\sale\datasources\charttotalRptComparePdt\rChartTotalRptComparePdtQty.php';
        $oChartTotalRptComparePdt    = new rChartTotalRptComparePdtQty(array(
            'aDataReturn'   => $aDataFiles,
            'aTextLang'     => $this->aTextLang
        ));
        ...
        $tHtmlViewChart     = $oChartTotalRptComparePdt->render('wChartTotalSaleComparePdtQty', true);
        $aDataConfigView    = [
            'tHtmlViewChart'    => $tHtmlViewChart
        ];
    ...
    // Return : None
    // Return Type : None
    public function FSvCDSHSALViewRptCompareSaleByPdt()
    {
    ...
    // Return : None
    // Return Type : None
    public function FSvCDSHSALViewRptCompareSaleByPdtQty()
    {
        ...
        require_once APPPATH . 'modules\sale\datasources\charttotalRptComparePdt\rChartTotalRptComparePdtQty.php';
        $oChartTotalRptComparePdtQty    = new rChartTotalRptComparePdtQty(array(
            'aDataReturn'   => $aDataFiles,
            'aTextLang'     => $this->aTextLang
        ));

        $oChartTotalRptComparePdtQty->run();

        $tHtmlViewChart     = $oChartTotalRptComparePdtQty->render('wChartTotalSaleComparePdtQty', true);
        $aDataConfigView    = [
            'tHtmlViewChart'    => $tHtmlViewChart
        ];
