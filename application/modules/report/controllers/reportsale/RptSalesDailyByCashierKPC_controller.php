...
class RptSalesDailyByCashierKPC_controller extends MX_Controller
{
    ...
    public function __construct()
    {
        ...
        $this->load->model('report/reportsale/RptSalesDailyByCashierKPC_model');
    ...
    {
        $this->aText = [
            'tTitleReport' => language('report/report/report', 'tRptTitleSalesDailyByCashierKPC'),
    ...
    public function index()
    {
        if (!empty($this->tRptExportType) && !empty($this->tRptCode)) {
            $this->RptSalesDailyByCashierKPC_model->FSnMExecStoreReport($this->aRptFilter);
    ...
    public function FSvCCallRptViewBeforePrint()
    {
        ...
        $aDataReport = $this->RptSalesDailyByCashierKPC_model->FSaMGetDataReport($aDataWhereRpt);
        ...
        $tRptView = JCNoHLoadViewAdvanceTable('report/datasources/rptSalesDailyByCashierKPC', 'wRptSalesDailyByCashierKPCHtml', $aDataViewRpt);
    ...
    public function FSoCChkDataReportInTableTemp($paDataSwitchCase)
    {
        try {
            ...
            $nDataCountPage = $this->RptSalesDailyByCashierKPC_model->FSnMCountDataReportAll($aDataCountData);
    ...
    public function FSvCCallRptRenderExcel()
    {
        ...
        $oStyleFontRight = (new StyleBuilder())
        ...
        $aCells = [
            ...
            WriterEntityFactory::createCell(null),
            WriterEntityFactory::createCell(null),
            WriterEntityFactory::createCell('จำนวนบิลขาย', $oStyleFontRight),
        ...
        $aCells = [
            ...
            WriterEntityFactory::createCell(null),
            WriterEntityFactory::createCell(null),
            WriterEntityFactory::createCell('จำนวน', $oStyleColumsRight),
        ...
        $aDataReport = $this->RptSalesDailyByCashierKPC_model->FSaMGetDataReport($aDataReportParams);

        if (isset($aDataReport['aRptData']) && !empty($aDataReport['aRptData'])) {
            foreach ($aDataReport['aRptData'] as $nKey => $aValue) {

                $nQTY = FCNnGetNumeric($aValue['FNRcvUseAmt']);
                if ($aValue['FTRcvRefNo1'] != '') {
                    // $nQTY = FCNnGetNumeric($aValue['FNRcvUseAmt']);
                    $tRcvName1 = '';
                    if( $aValue['FTRcvRefType'] == '1' ){
                        $tPrefix = '(' . $aValue['FTRcvRefNo1'] . ') ';
                    }else{
                        $tPrefix = 'Voucher : ';
                    }
                    $tRcvName2 = $tPrefix . $aValue['FTRcvRefNo2'];
                } else {
                    // if ($aValue['FNRcvUseAmtSumSub'] > 0) {
                    //     $nQTY = FCNnGetNumeric($aValue['FNRcvUseAmtSumSub']);
                    // } else {
                    //     $nQTY = '';
                    // }

                    $tRcvName1 = $aValue['FTRcvName'];
                    $tRcvName2 = '';
                }
                ...
                if ($aValue['FTTnsType'] == '1') {
                    ...
                    $nQTYSum = FCNnGetNumeric($aValue['FNRcvUseAmt']);
                    $nQTY    = "";
                } else {
                    $tColum1 = "";
                    $nQTYSum = "";
                ...
                $values = [
                    ...
                    WriterEntityFactory::createCell($tRcvName1),
                    WriterEntityFactory::createCell($tRcvName2),
                    WriterEntityFactory::createCell(null),
                    WriterEntityFactory::createCell(null),
                    WriterEntityFactory::createCell(null),
                    WriterEntityFactory::createCell($nQTYSum),
                    WriterEntityFactory::createCell($nQTY),
