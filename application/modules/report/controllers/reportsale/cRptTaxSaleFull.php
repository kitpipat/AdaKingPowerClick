...
class cRptTaxSaleFull extends MX_Controller
{
    ...
    public function __construct()
    {
        ...
        $this->load->model('report/reportsale/mRptTaxSaleFull');
    ...
    public function index()
    {
        ...
        if (!empty($this->tRptCode) && !empty($this->tRptExportType)) {
            ...
            $this->mRptTaxSaleFull->FSnMExecStoreReport($this->aRptFilter);
            // Count Rows
            $aCountRowParams = [
            ...
            $this->nRows = $this->mRptTaxSaleFull->FSnMCountRowInTemp($aCountRowParams);
    ...
    public function FSvCCallRptViewBeforePrint()
    {
        try {
            ...
            $aDataReport = $this->mRptTaxSaleFull->FSaMGetDataReport($aDataReportParams);
            /** =========== End Get Data ===================================== */
            /** =========== Begin Render View ================================ */
    ...
    //         'tUsrSessionID' => $this->tUserSessionID,
    //     );
    //     $aDataReport = $this->mRptTaxSaleFull->FSaMGetDataReport($aGetDataReportParams);
    //     /** =========== End Get Data ========================================= */
    //     try {
    ...
    public function FSoCChkDataReportInTableTemp()
    {
        try {
            ...
            $nDataCountPage = $this->mRptTaxSaleFull->FSnMCountRowInTemp($aDataCountData);
    ...
    public function FSvCCallRptRenderExcel()
    {
        ...
        $aCells = [
            ...
            WriterEntityFactory::createCell(null),
            WriterEntityFactory::createCell(language('report/report/report', 'tRptReason')),
            WriterEntityFactory::createCell(null),
        ...
        if (isset($aDataReport['aRptData']) && !empty($aDataReport['aRptData'])) {
            ...
            foreach ($aDataReport['aRptData'] as $nKey => $aValue) {
                ...
                $values = [
                    ...
                    WriterEntityFactory::createCell(null),
                    WriterEntityFactory::createCell((!empty($aValue['FTRsnCode']) ? $aValue['FTRsnName'] : "-")),
                    WriterEntityFactory::createCell(null),
