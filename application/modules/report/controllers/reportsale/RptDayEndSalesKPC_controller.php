...
class RptDayEndSalesKPC_controller extends MX_Controller
{
    ...
    public function __construct()
    {
        ...
        $this->load->model('report/reportsale/RptDayEndSalesKPC_model');
    ...
    private function init()
    {
        $this->aText = [
            ...
            'tRptEndDaySaleTitle'   => language('report/report/report', 'tRptEndDaySaleKPCTitle'),
            ...
            'tRptEndDaySaleTypePos' => language('report/report/report', 'tRptEndDaySaleTypePos'),
            ...
            'tRptPosType0'           => language('report/report/report', 'tRptPosType'),
            'tRptPosType1'          => language('report/report/report', 'tRptPosType1'),
            'tRptPosType2'          => language('report/report/report', 'tRptPosType2'),

            'tRptEndDaySaleMerFrom'   => language('report/report/report', 'tRptEndDaySaleMerFrom'),
            'tRptEndDaySaleMerTo'     => language('report/report/report', 'tRptEndDaySaleMerTo'),
            'tRptEndDaySaleShopFrom'  => language('report/report/report', 'tRptEndDaySaleShopFrom'),
            'tRptEndDaySaleShopTo'    => language('report/report/report', 'tRptEndDaySaleShopTo'),
            'tRptEndDaySalePosFrom'   => language('report/report/report', 'tRptEndDaySalePosFrom'),
            'tRptEndDaySalePosTo'     => language('report/report/report', 'tRptEndDaySalePosTo'),
            'tRptBranch'              => language('report/report/report', 'tRptBranch'),
            'tRptAll'                 => language('report/report/report', 'tRptAll'),

            // Header
            'tRptEndDaySaleDetail'  => language('report/report/report', 'tRptEndDaySaleDetail'),
            'tRptEndDaySaleSum'     => language('report/report/report', 'tRptEndDaySaleSum'),
            'tRptEndDaySale'        => language('report/report/report', 'tRptEndDaySale'),
            'tRptEndDayDiscount'    => language('report/report/report', 'tRptEndDayDiscount'),
            'tRptEndDayRound'       => language('report/report/report', 'tRptEndDayRound'),
            'tRptEndDayTotalSale'   => language('report/report/report', 'tRptEndDayTotalSale'),
            'tRptSalesdonotIncludetax'  => language('report/report/report', 'tRptSalesdonotIncludetax'),
            'tRptEndDaySaleTax'     => language('report/report/report', 'tRptEndDaySaleTax'),
            'tRptEndDayOrther'      => language('report/report/report', 'tRptEndDayOrther'),
            'tRptEndDaySaleSumTotal' => language('report/report/report', 'tRptEndDaySaleSumTotal'),
            ...
            'tRptEndDaySaleQTY'     => language('report/report/report', 'tRptEndDaySaleQTY'),
        ...
        $this->aRptFilter = [
            ...
            'tPosType'      => !empty($this->input->post('ocmPosType')) ? $this->input->post('ocmPosType') : "0"
        ];
    ...
    public function index()
    {
        if (!empty($this->tRptExportType) && !empty($this->tRptCode)) {
            ...
            $this->RptDayEndSalesKPC_model->FSnMExecStoreReport($this->aRptFilter);
     ...
     * ReturnType: View
     */
    public function FSvCCallRptViewBeforePrint($paData)
    {
        $aDataWhere = array(
            'tUserSession' => $this->tUserSessionID,
        ...
        // Get Data Report
        $aDataReport = $this->RptDayEndSalesKPC_model->FSaMGetDataReport($aDataWhere);
        ...
        $tRptView     = JCNoHLoadViewAdvanceTable('report/datasources/rptDayEndSalesKPC', 'wRptDayEndSalesKPCHtml.view', $aDataViewRptParams);

        $aDataViewerParams = [
            'tTitleReport'    => $this->aText['tRptEndDaySaleTitle'],
            'tRptTypeExport'  => $this->tRptExportType,
            'tRptCode'        => $this->tRptCode,
            'tRptRoute'       => $this->tRptRoute,
    ...
    public function FSvCCallRptViewBeforePrintClickPage()
    {
        ...
        $tRptView     = JCNoHLoadViewAdvanceTable('report/datasources/rptDayEndSalesKPC', 'wRptDayEndSalesKPCHtml.view', $aDataViewRpt);
     ...
     * Functionality: Click Page Report (Report Viewer)
     * Parameters:  Function Parameter
     * Creator: 30/05/2019 Witsarut (Bell)
     * LastUpdate: -
    ...
    public function FSoCChkDataReportInTableTemp($paDataSwitchCase)
    {
        try {
            ...
            $nDataCountPage = $this->RptDayEndSalesKPC_model->FSnMCountDataReportAll($aDataCountData);
    ...
    {
        $tFileName = $this->aText['tRptEndDaySaleTitle'] . '_' . date('YmdHis') . '.xlsx';
        ...
        $aCells = [
            WriterEntityFactory::createCell(language('report/report/report', 'tRptEndDaySaleDetail')),
            ...
            WriterEntityFactory::createCell(null),
            WriterEntityFactory::createCell(null),
            WriterEntityFactory::createCell(language('report/report/report', 'tRptEndDaySaleQTY')),
            WriterEntityFactory::createCell(null),
            WriterEntityFactory::createCell($this->aText["tRptEndDaySaleSum"]),
        ];
        ...
        // Get Data Report
        $aDataReport = $this->RptDayEndSalesKPC_model->FSaMGetDataReport($aDataReportParams);
        ...
        if (isset($aDataReport['aRptData']) && !empty($aDataReport['aRptData'])) {
            ...
            foreach ($aDataReport['aRptData'] as $nKey => $aValue) {
                ...
                if ($aValue['FTRcvCode'] != '') {
                    $tGrand_Footer2      += $aValue["FNRcvUseAmt"];
                }

                // $tFooterValUse2 = $tGrand_Footer2;

                $values = [
                    WriterEntityFactory::createCell($tValType),
                    WriterEntityFactory::createCell($tBankName),
                    WriterEntityFactory::createCell(null),
                    WriterEntityFactory::createCell(null),
                    WriterEntityFactory::createCell(null),
                    WriterEntityFactory::createCell(null),
                    ...
                    WriterEntityFactory::createCell(null),
                    WriterEntityFactory::createCell(null),
                    WriterEntityFactory::createCell($nRcvUseAmt),
                    WriterEntityFactory::createCell(null),
                ...
                if ($aValue['FTXihValType'] == '4') {
                    ...
                    $tGrand_Footer      = $aValue["FCXshGrand"] - $cSalRound;
                }

                if (($nKey + 1) == FCNnHSizeOf($aDataReport['aRptData'])) { //SumFooter
                    $values = [
                        WriterEntityFactory::createCell($this->aText["tRptEndDaySaleSumTotal"]),
                        WriterEntityFactory::createCell(null),
                        WriterEntityFactory::createCell(null),
                        WriterEntityFactory::createCell(null),
                        WriterEntityFactory::createCell(null),
                        ...
                        WriterEntityFactory::createCell(null),
                        WriterEntityFactory::createCell(null),
                        WriterEntityFactory::createCell(FCNnGetNumeric($tGrand_Footer)),
                    ];
                    $aRow = WriterEntityFactory::createRow($values, $oStyleColums);
                    $oWriter->addRow($aRow);

                    $values = [
                        WriterEntityFactory::createCell('รวมจำนวนครั้งการใช้'),
                        WriterEntityFactory::createCell(null),
                        WriterEntityFactory::createCell(null),
                        WriterEntityFactory::createCell(null),
                        WriterEntityFactory::createCell(null),
                        ...
                        WriterEntityFactory::createCell(null),
                        WriterEntityFactory::createCell(null),
                        WriterEntityFactory::createCell(FCNnGetNumeric($tGrand_Footer2)),
                        WriterEntityFactory::createCell(null),
                        WriterEntityFactory::createCell(null),
                    ];
                    $aRow = WriterEntityFactory::createRow($values, $oStyleColums);
                    ...
                    $values = [
                        WriterEntityFactory::createCell('รวมจำนวนบิล'),
                        WriterEntityFactory::createCell(null),
                        WriterEntityFactory::createCell(null),
                        WriterEntityFactory::createCell(null),
                        WriterEntityFactory::createCell(null),
                        ...
                        WriterEntityFactory::createCell(null),
                        WriterEntityFactory::createCell(null),
                        WriterEntityFactory::createCell(FCNnGetNumeric($aValue['FNBillSalTotal'])),
                        WriterEntityFactory::createCell(null),
                        WriterEntityFactory::createCell(null),
                    ];
                    $aRow = WriterEntityFactory::createRow($values, $oStyleColums);
    ...
    public function FSoCCallRptRenderHedaerExcel()
    {
        ...
        $aCells = [
            ...
            WriterEntityFactory::createCell(null),
            WriterEntityFactory::createCell(null),
            WriterEntityFactory::createCell($this->aText['tRptEndDaySaleTitle']),
            WriterEntityFactory::createCell(null),
            WriterEntityFactory::createCell(null),
            WriterEntityFactory::createCell(null),
        ];
