<div class="panel panel-headline">
    <div class="panel-heading">
        <div class="row">
            <div class="col-xs-3 col-sm-3 col-md-3 col-lg-3">
                <div class="form-group">
                    <div class="input-group">
                        <input class="form-control xCNInpuASTthoutSingleQuote" type="text" id="oetSearchAll" name="oetSearchAll" placeholder="<?= language('document/adjuststock/adjuststock', 'tASTFillTextSearch') ?>" onkeyup="Javascript:if(event.keyCode==13) JSvTWOCallPageTransferwarehouseoutDataTable()" autocomplete="off">
                        <span class="input-group-btn">
                            <button type="button" class="btn xCNBtnDateTime" onclick="JSvTWOCallPageTransferwarehouseoutDataTable()">
            ...
            <a id="oahTRNSearchReset" class="btn xCNBTNDefult xCNBTNDefult1Btn" href="javascript:;" onclick="JSxTWOClearSearchData()"><?= language('common/main/main', 'tClearSearch'); ?></a>
        </div>
        <!--ค้นหาขั้นสูง-->
                ...
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-3 col-lg-3">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <input class="form-control xCNHide" type="text" id="oetASTBchCodeFrom" name="oetASTBchCodeFrom" value="<?=$tBchCodeDefault;?>" maxlength="5">
                                <input class="form-control xWPointerEventNone" type="text" id="oetASTBchNameFrom" name="oetASTBchNameFrom" value="<?=$tBchNameDefault;?>" placeholder="<?php echo language('document/adjuststock/adjuststock', 'tASTAdvSearchFrom'); ?>" readonly>
                                <span class="input-group-btn">
                                    <button id="obtASTBrowseBchFrom" type="button" class="btn xCNBtnBrowseAddOn" <?=$tBrowseBchDisabled;?> ><img class="xCNIconFind"></button>
                                </span>
                            </div>
                        </div>
                    </div>
                    <div class="col-xs-12 col-sm-6 col-md-3 col-lg-3">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <input class="form-control xCNHide" id="oetASTBchCodeTo" name="oetASTBchCodeTo" value="<?=$tBchCodeDefault;?>" maxlength="5">
                                <input class="form-control xWPointerEventNone" type="text" id="oetASTBchNameTo" name="oetASTBchNameTo" value="<?=$tBchNameDefault;?>" placeholder="<?php echo language('document/adjuststock/adjuststock', 'tASTAdvSearchTo'); ?>" readonly>
                                <span class="input-group-btn">
                                    <button id="obtASTBrowseBchTo" type="button" class="btn xCNBtnBrowseAddOn" <?=$tBrowseBchDisabled;?> ><img class="xCNIconFind"></button>
                                </span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-3 col-lg-3">
                        <div class="form-group">
                            <label class="xCNLabelFrm"><?php echo language('document/adjuststock/adjuststock', 'tASTAdvSearchDocDateTo'); ?></label>
                            <div class="input-group">
                ...
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-2 col-lg-2">
                        <div class="form-group" style="width: 60%;">
                            ...
                            <button id="obtTWOSubmitFrmSearchAdv" class="btn xCNBTNPrimery" style="width:100%" ><?php echo language('common/main/main', 'tSearch'); ?></button>
                        </div>
                    </div>
                ...
                <div id="odvMngTableList" class="btn-group xCNDropDrownGroup">
                    ...
                    <ul class="dropdown-menu" role="menu">
                        <li id="oliBtnDeleteAll" class="disabled">
                            <a data-toggle="modal" data-target="#odvTWOModalDelDocMultiple"><?= language('common/main/main', 'tDelAll') ?></a>
                        </li>
                    </ul>
                </div>
            </div>
    ...
    <div class="panel-body">
        <section id="ostContentTransferwarehouseout"></section>
    </div>
</div>

<script src="<?= base_url('application/modules/common/assets/js/jquery.mask.js') ?>"></script>
<script src="<?= base_url('application/modules/common/assets/src/jFormValidate.js') ?>"></script>
<?php include('script/jTransferwarehouseoutSearchList.php') ?>