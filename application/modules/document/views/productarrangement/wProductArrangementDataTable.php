            ...
            <table id="" class="table table-striped">
                <thead>
                    <tr class="xCNCenter">
                        ...
                        <?php endif; ?>
                        <th nowrap class="xCNTextBold" style="width:10%;"><?php echo language('document/productarrangement/productarrangement','tPAMBchName')?></th>
						<th nowrap class="xCNTextBold" style="width:12%;"><?php echo language('document/productarrangement/productarrangement','tPAMDocNo')?></th>
                        <th nowrap class="xCNTextBold" style="width:8%;"><?php echo language('document/productarrangement/productarrangement','tPAMDocDate')?></th>
                        <th nowrap class="xCNTextBold" style="width:12%;"><?php echo language('document/productarrangement/productarrangement','tPAMRefInt')?></th>
                        <th nowrap class="xCNTextBold" style="width:10%;"><?php echo language('document/productarrangement/productarrangement','tPAMStaApv')?></th>
                        <th nowrap class="xCNTextBold" style="width:10%;"><?php echo language('document/productarrangement/productarrangement','tPAMCreateBy')?></th>
                        <?php if($aAlwEvent['tAutStaFull'] == 1 || $aAlwEvent['tAutStaDelete'] == 1) : ?>
                    ...
                    <?php if($aDataList['rtCode'] == 1 ):?>
                        <?php foreach($aDataList['raItems'] AS $nKey => $aValue): ?>
                            <?php
                                ...
                                // $tPAMRefInCode  = $aValue['FTXthRefInt'];
                                ...
                                if(!empty($aValue['FTXthStaApv']) || $aValue['FTXthStaDoc'] == 3){
                                    ...
                                    $tClassDisabled = '';
                                    $tTitle = '';
                                    $tOnclick = "onclick=JSoPAMDelDocSingle('".$nCurrentPage."','".$tPAMDocNo."','".$tPAMBchCode."')"; //,'".$tPAMRefInCode."'
                                }
                            ...
                            <tr class="text-center xCNTextDetail2 xWPIDocItems" id="otrPurchaseInvoice<?php echo $nKey?>" data-code="<?php echo $aValue['FTXthDocNo']?>" data-name="<?php echo $aValue['FTXthDocNo']?>">
                                <?php if($aAlwEvent['tAutStaFull'] == 1 || $aAlwEvent['tAutStaDelete'] == 1) : ?>
                                    <td nowrap class="text-center">
                                        <label class="fancy-checkbox ">
                                            <input id="ocbListItem<?php echo $nKey?>" type="checkbox" class="ocbListItem" name="ocbListItem[]" value="<?=$tPAMDocNo?>" data-bchcode="<?=$tPAMBchCode?>" <?php echo $tCheckboxDisabled;?>> <!-- data-refcode="<?=$tPAMRefInCode?>" -->
...
<!-- ======================================================================================================================================== -->
<?php include('script/jProductArrangementDataTable.php')?>
