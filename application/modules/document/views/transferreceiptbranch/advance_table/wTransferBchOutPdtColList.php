<div style="height:350px;overflow:auto;">
        <table class="table table-bordered table-striped" id="otbOrderListDetail">
                ...
                <tr>
                    <td><?=$i?></td>
                    <td><label contenteditable="true" class="olbTransferBchOutColumnLabelName"><?php echo $ShowColVal->FTShwNameUsr?></label></td>
                    <td class="text-center">
                    <input class="ocbTransferBchOutPdtColStaShow" type="checkbox" <?=$tChecked?> data-id="<?=$ShowColVal->FTShwFedShw?>">
                    </td>
                </tr>
                <?php $i++; ?>
                <?php } ?>
