                        ...
                        >
                            ...
                            ?>
                                <td nowrap class="<?=$tAlignFormat?>">
                                    ...
                                    <?php if( ($DataVal->FTShwStaAlwEdit == 1 && in_array($tColumnName, ['FCXtdSetPrice','FCXtdQty']) && (empty($tTWIStaApv) && $tTWIStaDoc != 3)) && ($aDataTableVal['FTTmpStatus']!=5) && $bAlwQtyPickNotEqQtyOrd ===true):?>
                                            <label
                                    ...
                                    <?php else: ?>
                                        ...
                                        <?php }else{
                                                if($tColumnName=='FCXtdQty'){
                                                    ...
                                                    $tIconEdit = " <img class='xCNIconTable' src=".base_url('application/modules/common/assets/images/icons/edit.png')." title='Remove'>";
                                                }else{
                                                    $tClassName = 'xCNTextLink';
                                                    $tIconEdit = "";
                                                }
