...
class cProducttransferwahouse extends MX_Controller
{
    ...
    */
    ...
    {
        // $tXthDocNo = $this->input->post("ptXthDocNo");
        // $aGetInforTwxHD = $this->mProducttransferwahouse->FSxMTWFGeTInforTwxHD($tXthDocNo);
        // $aGetInforTwxHDRef = $this->mProducttransferwahouse->FSxMTWFGeTInforTwxHDRef($tXthDocNo);
        // $aGetInforTwxDT = $this->mProducttransferwahouse->FSxMTWFGeTInforTwxDT($tXthDocNo);
