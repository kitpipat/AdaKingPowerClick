...
<head>
	...
	<title>Frm_SQL_ALLMPdtBillTnfInBch.mrt - Viewer</title>
	...
	<script type="text/javascript">
		function Start() {
			...
			report.loadFile("reports/Frm_SQL_ALLMPdtBillTnfInBch.mrt?v=1.0.2");
			...
			// report.dictionary.variables.getByName("SP_tDocNo").valueObject = "TB000012200216";
