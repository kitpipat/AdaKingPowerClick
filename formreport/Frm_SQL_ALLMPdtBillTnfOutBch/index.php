...
<head>
	...
	<title>Frm_SQL_ALLMPdtBillTnfOutBch.mrt - Viewer</title>
	...
	<script type="text/javascript">
		function Start() {
			...
			report.loadFile("reports/Frm_SQL_ALLMPdtBillTnfOutBch.mrt?=1.0.4");
			...
			// report.dictionary.variables.getByName("SP_tCompCode").valueObject = "00000";
			// report.dictionary.variables.getByName("SP_tCmpBch").valueObject = "00000";
			// report.dictionary.variables.getByName("SP_tDocNo").valueObject = "BS0000022000220";
			// report.dictionary.variables.getByName("SP_nAddSeq").valueObject = 1;
			// report.dictionary.variables.getByName("SP_tDocBch").valueObject = "00000";
