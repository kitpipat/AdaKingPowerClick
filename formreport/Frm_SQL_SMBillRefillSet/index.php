...
<head>
	...
	<title>Frm_SQL_SMBillRefillSet.mrt - Viewer</title>
	...
	<script type="text/javascript" src="<?=BASE_URL?>/formreport/AdaCoreFrmReport/scripts/stimulsoft.reports.engine.js"></script>
	<script type="text/javascript" src="<?=BASE_URL?>/formreport/AdaCoreFrmReport/scripts/stimulsoft.reports.export.js"></script>
	<script type="text/javascript" src="<?=BASE_URL?>/formreport/AdaCoreFrmReport/scripts/stimulsoft.viewer2022.js"></script> 
	...
	<script type="text/javascript">
		function Start() {
			...
			report.loadFile("reports/Frm_SQL_SMBillRefillSet.mrt?v=1.0.2");
			...
			// report.dictionary.variables.getByName("SP_tCompCode").valueObject = "00011";
			// report.dictionary.variables.getByName("SP_tCmpBch").valueObject = "00000";
			// report.dictionary.variables.getByName("SP_tDocNo").valueObject = "RP0001522000003";
