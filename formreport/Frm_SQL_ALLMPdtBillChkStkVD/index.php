...
<head>
	...
	<title>Frm_SQL_ALLMPdtBillChkStkVD.mrt - Viewer</title>
	...
	<script type="text/javascript">
		function Start() {
			...
			report.loadFile("reports/Frm_SQL_ALLMPdtBillChkStkVD.mrt?v=1.0.6");
			...
			// report.dictionary.variables.getByName("SP_tDocNo").valueObject = "AS0000022000002";
