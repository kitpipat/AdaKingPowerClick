...
<head>
	...
	<title>Frm_SQL_SMSBillDo.mrt - Viewer</title>
	...
	<script type="text/javascript">
		function Start() {
			...
			report.loadFile("reports/Frm_SQL_SMSBillDo.mrt?v=1.0.1");
			...
			// report.dictionary.variables.getByName("SP_tDocNo").valueObject = "DS0001122-000013";
