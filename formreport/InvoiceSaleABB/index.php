...
<head>
	...
	<script type="text/javascript">
		function Start() {
			...
			report.loadFile("reports/Frm_PSInvoiceSale_ABB.mrt?=1.0.1");
			...
			// report.dictionary.variables.getByName("SP_tCmpBch").valueObject = "00011";
			// report.dictionary.variables.getByName("SP_nAddSeq").valueObject = 3;
			// report.dictionary.variables.getByName("SP_tDocNo").valueObject = "S2200011000070000138";
